...
Developer Productivity's definition matters. Discussing and optimizing an unclear measure wastes time. When I set out to define Developer Productivity ¹, two problems stood out ([among](https://link.springer.com/chapter/10.1007/978-1-4842-4221-6_2) [many](https://newsletter.pragmaticengineer.com/p/measuring-developer-productivity)). The metric is ineffective for improving stakeholder and business outcomes. The term's ambiguity causes more problems than it solves for anyone learning about Developer Productivity, defining it, or discussing engineering optimization. Platform teams can save time and improve engineering outcomes by selecting more impactful metrics and replacing the term "Developer Productivity" with an alternative like "Engineering Results".
...
Developers' productivity (input to output conversion efficiency across their activities) is ineffective for improving what we care about.
